...
export const featureRows: FeatureRow[] = [
  ...
  {
    name: "Favorites",
    body: "Pin the files you keep coming back to. They sit in a FAVORITES section between Recents and your folders, in the order you arranged them — star a file from the tree, any context menu, ⌘D for the open document, or the ⌘P palette; drag to reorder, hover × to unpin. A pinned file drops out of Recents, so opening it never shuffles it away.",
  },
  {
